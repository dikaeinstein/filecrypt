...
func main() {
	...
	if *unpack || *extract || *list {
		...
		print("Writing file...")
		err = os.WriteFile(*out, fData, 0o644)
		dieIf(err)
	}
...
func usage() {
	...
	fmt.Printf(`Filecrypt is a file encryptor. It uses passwords to generate the key.
%s version %s, (c) 2024 Dika Okwa
